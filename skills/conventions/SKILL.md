...
| **results** | how is an experiments section shaped, and how are ablations designed? | `docs-results` (setup states how every statistic is built, finding head plus two or three numbers plus one reason, ablations by design family with alternatives, trends as figures) |
